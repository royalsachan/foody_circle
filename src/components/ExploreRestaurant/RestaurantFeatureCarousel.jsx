...
const RestaurantCard = ({ image, name, rating, cuisine, location, price, distance, offers }) => {
  return (
    <div className="flex-shrink-0 w-[85vw] sm:w-[400px] bg-orange-200 md:w-[450px] rounded-2xl overflow-hidden shadow-lg mx-2 transition duration-300 hover:shadow-2xl hover:shadow-orange-500 border-2 border-transparent hover:border-orange-500">
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-5 space-y-2">
          ...
          <div className="mt-4">
          <button 
            className="w-full bg-green-600 text-white font-semibold py-2 rounded-full transition duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-green-300 hover:bg-green-700"
          >
            Order Now
          </button>
        </div>
...
const RestaurantCarousel = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-gray-100 via-gray-200 to-white py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-5 -mt-5 text-center text-gray-800">
        ...
        <Carousel 
          ...
          renderCenterLeftControls={({ previousSlide }) => (
            <button onClick={previousSlide} className="p-2 rounded-full bg-gray-300 hover:bg-gray-400">
              &lt;
            </button>
          )}
